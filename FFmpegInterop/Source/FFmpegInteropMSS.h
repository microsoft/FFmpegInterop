...
namespace FFmpegInterop
{
	...
	public:
		...
		static FFmpegInteropMSS^ CreateFFmpegInteropMSSFromStream(IRandomAccessStream^ stream, FFmpegInteropConfig^ config, MediaStreamSource^ mss);
		static FFmpegInteropMSS^ CreateFFmpegInteropMSSFromStream(IRandomAccessStream^ stream, FFmpegInteropConfig^ config);
		static FFmpegInteropMSS^ CreateFFmpegInteropMSSFromStream(IRandomAccessStream^ stream);
		...
		static FFmpegInteropMSS^ CreateFFmpegInteropMSSFromUri(String^ uri, FFmpegInteropConfig^ config);
		static FFmpegInteropMSS^ CreateFFmpegInteropMSSFromUri(String^ uri);
