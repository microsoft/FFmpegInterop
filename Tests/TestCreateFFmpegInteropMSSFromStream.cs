...
namespace UnitTest.Windows
{
    ...
    public class CreateFFmpegInteropMSSFromStream
    {
        ...
        {
            // FFmpegInteropMSS.InitFromStream should throw if stream is null with default parameter
            try
            {
            ...
            // FFmpegInteropMSS.InitFromStream should return null if stream is null with non default parameter
            try
            {
        ...
        public async Task CreateFromStream_Bad_Input()
        {
            ...
            // FFmpegInteropMSS.InitFromStream should throw since test.txt is not a valid media file
            try
            {
